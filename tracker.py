...
send_to_email = "dipala8504@eyeremind.com"
...
email_content = """\
        ...
        <body>
            ...
            <br><br>
            <a style="background-color:red; color:white; padding: 25px; text-decoration:None;" href="{arg6}"> View Product</a>
        </body>
        </html>   
        """
...
class Amazon_item:
    ...
    def __init__(self, prod_url):
        request = requests.get(
            "http://192.168.100.227:8050/render.html", params={"url": prod_url, "wait": 3})
...
class Price_tracker:
    ...
    def send_mail(self):
        for product in self.products:
            ...
            mail_content = ""
            self.item = product.values()
            for info in self.item:
                _name = info.get("Name")
